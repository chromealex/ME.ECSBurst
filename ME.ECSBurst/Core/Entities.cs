...
namespace ME.ECSBurst {
    ...
    public struct Storage {
        ...
        internal NativeListBurst<int> alive;
        internal NativeListBurst<int> dead;
        internal NativeListBurst<int> deadPrepared;
        ...
        [System.Runtime.CompilerServices.MethodImplAttribute(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
        #endif
        public NativeListBurst<int> GetAlive() {
        ...
        public void Initialize(int capacity) {
            ...
            this.alive = new NativeListBurst<int>(capacity, Allocator.Persistent);
            this.dead = new NativeListBurst<int>(capacity, Allocator.Persistent);
            this.deadPrepared = new NativeListBurst<int>(capacity, Allocator.Persistent);
            this.aliveCount = 0;
            this.entityId = -1;
        ...
        public void ApplyDead() {
            ...
            if (cnt > 0) {
                ...
                for (int i = 0; i < cnt; ++i) {
                    ...
                    --this.aliveCount;
                    this.dead.Add(id);
                    this.alive.RemoveAt(ArrayUtils.IndexOf(ref this.alive, id));
