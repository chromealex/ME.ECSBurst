...
namespace ME.ECSBurst {
    ...
    public static partial class ArrayUtils {
        ...
        [Unity.Collections.BurstCompatibleAttribute(GenericTypeArguments = new [] { typeof(int), typeof(int) })]
        public static unsafe int IndexOf<T, U>(ref NativeListBurst<T> list, U value) where T : struct, System.IEquatable<U> {
            
            return IndexOf<T, U>(list.m_ListData->Ptr, list.Length, value);
            
        }

        [Unity.Collections.BurstCompatibleAttribute(GenericTypeArguments = new [] { typeof(int), typeof(int) })]
        public static unsafe int IndexOf<T, U>(void* ptr, int length, U value) where T : struct, System.IEquatable<U> {
        ...
        [System.Runtime.CompilerServices.MethodImplAttribute(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
        #endif
        public static void Copy<T>(in NativeListBurst<T> fromArr, ref NativeListBurst<T> arr) where T : struct {
            ...
            if (arr.IsCreated == false) {
                ...
                if (arr.IsCreated == true) arr.Dispose();
                arr = new NativeListBurst<T>(fromArr.Length, Unity.Collections.Allocator.Persistent);
