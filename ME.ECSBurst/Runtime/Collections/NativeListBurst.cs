//#define ENABLE_COLLECTIONS_CHECKS
...
namespace ME.ECSBurst.Collections {
    ...
    public interface INativeListBurst<T> where T : struct
    {
        /// <summary>
        ///
        /// </summary>
    ...
    public unsafe struct NativeListBurst<T>
        : INativeDisposable
        , INativeListBurst<T>
        , IEnumerable<T> // Used by collection initializers.
        where T : struct
    {
#if ENABLE_COLLECTIONS_CHECKS
        ...
        public NativeListBurst(Allocator allocator)
            : this(1, allocator, 2)
        {
        }
        ...
        /// <param name="allocator">A member of the
        /// [Unity.Collections.Allocator](https://docs.unity3d.com/ScriptReference/Unity.Collections.Allocator.html) enumeration.</param>
        public NativeListBurst(int initialCapacity, Allocator allocator)
            : this(initialCapacity, allocator, 2)
        {
        }

        NativeListBurst(int initialCapacity, Allocator allocator, int disposeSentinelStackDepth)
        {
        ...
        public T this[int index]
        {
            get
            {
                ...
                return UnsafeUtility.ReadArrayElement<T>(m_ListData->Ptr, ArrayUtils.AssumePositive(index));
            }
            set
            {
#if ENABLE_COLLECTIONS_CHECKS
...
#endif
                CheckIndexInRange(index, m_ListData->Length);
                UnsafeUtility.WriteArrayElement(m_ListData->Ptr, ArrayUtils.AssumePositive(index), value);
            }
        }
        ...
        public int Length
        {
            get
            {
                ...
                AtomicSafetyHandle.CheckReadAndThrow(m_Safety);
#endif
                return ArrayUtils.AssumePositive(m_ListData->Length);
            }
        ...
        public int Capacity
        {
            get
            {
                ...
                AtomicSafetyHandle.CheckReadAndThrow(m_Safety);
#endif
                return ArrayUtils.AssumePositive(m_ListData->Capacity);
            }
        ...
        /// If the list has reached its current capacity, internal array won't be resized, and exception will be thrown.
        /// </remarks>
        public void AddRangeNoResize(NativeListBurst<T> list)
        {
#if ENABLE_COLLECTIONS_CHECKS
            AtomicSafetyHandle.CheckWriteAndThrow(m_Safety);
#endif
        ...
        public void AddRange(void* elements, int count)
        {
            ...
            m_ListData->AddRange<T>(elements, ArrayUtils.AssumePositive(count));
        }
        ...
        public void InsertRangeWithBeginEnd(int begin, int end)
        {
            ...
            AtomicSafetyHandle.CheckWriteAndBumpSecondaryVersion(m_Safety);
#endif
            m_ListData->InsertRangeWithBeginEnd<T>(ArrayUtils.AssumePositive(begin), ArrayUtils.AssumePositive(end));
        }
        ...
        public void RemoveAtSwapBack(int index)
        {
            ...
            AtomicSafetyHandle.CheckWriteAndBumpSecondaryVersion(m_Safety);
#endif
            m_ListData->RemoveAtSwapBack<T>(ArrayUtils.AssumePositive(index));
        }
        ...
        public void RemoveRangeSwapBackWithBeginEnd(int begin, int end)
        {
            ...
            AtomicSafetyHandle.CheckWriteAndBumpSecondaryVersion(m_Safety);
#endif
            m_ListData->RemoveRangeSwapBackWithBeginEnd<T>(ArrayUtils.AssumePositive(begin), ArrayUtils.AssumePositive(end));
        }
        ...
        public void RemoveAt(int index)
        {
            ...
            AtomicSafetyHandle.CheckWriteAndBumpSecondaryVersion(m_Safety);
#endif
            m_ListData->RemoveAt<T>(ArrayUtils.AssumePositive(index));
        }
        ...
        public static implicit operator NativeArray<T>(NativeListBurst<T> nativeList)
        {
        ...
        public unsafe struct ParallelWriter
        {
            ...
            {
                CheckArgPositive(length);
                AddRangeNoResize(UnsafeUtility.SizeOf<T>(), UnsafeUtility.AlignOf<T>(), ptr, ArrayUtils.AssumePositive(length));
            }
